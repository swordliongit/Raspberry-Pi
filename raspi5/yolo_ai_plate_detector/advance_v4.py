...
class LicensePlateReader:
    def __init__(self):
        ...
        self.read_cooldown = 0.1  # Faster updates
        self.reset_threshold = 0.2  # Position change threshold
        
        # Plate locking mechanism
        self.locked_plate = None
        self.lock_time = None
        self.lock_duration = 0.5  # Short lock duration for faster transitions
